...
@section('main')
    ...
    <div class="add-product-container">
        <div class="text-lg-center add-product-title">Register as <span class="txt-green">Organizer</span>
        </div>
        <form class="container" action="{{route('roleRegisOrganizer')}}" method="POST" enctype="multipart/form-data">
            @csrf
